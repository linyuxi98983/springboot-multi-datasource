...
@EnableJpaRepositories(value = "com.imooc.dao.repository", entityManagerFactoryRef = "entityManagerFactory",
...
public class JpaEntityManager
{
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactoryBean(EntityManagerFactoryBuilder builder)
    {
        ...
        return builder.dataSource(routingDataSource())// 关键：注入routingDataSource
                .properties(properties).packages("com.imooc.entity").persistenceUnit("myPersistenceUnit").build();
    }
